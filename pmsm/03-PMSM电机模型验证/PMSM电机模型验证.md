...
![image-20251125212538777](./assets/image-20251125212538777.png)
...
控制器设计中，电机模型使用的是前馈补偿后的PMSM传递函数，实际的电机模型中需要进行前馈解耦。

代入数学模型创建的电机模型，增加解耦部分，并对simulink模型进行验证。

![image-20251125224939775](./assets/image-20251125224939775.png)

对比两个模型的输出，完全一致。

![image-20251125225109459](./assets/image-20251125225109459.png)

![image-20251125225124745](./assets/image-20251125225124745.png)
